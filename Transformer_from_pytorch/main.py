# This Code was followed based on a tutorial by Aladdin Persson https://www.youtube.com/watch?v=U0s0f995w14
import torch
...
print(device)
x = torch.tensor([[1,5,6,4,3,9,2,0],[1,8,7,3,4,5,6,7]]).to(device)
